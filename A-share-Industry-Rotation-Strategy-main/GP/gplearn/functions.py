...
def _make_ts_max(window):
    def _ts_max(x1):
        if x1.ndim != 1:
            return np.full_like(x1, np.nan)
        s = pd.Series(x1)
        return s.rolling(window, min_periods=1).max().fillna(0).values
    return _ts_max
...
def _make_ts_min(window):
    def _ts_min(x1):
        if x1.ndim != 1:
            return np.full_like(x1, np.nan)
        s = pd.Series(x1)
        return s.rolling(window, min_periods=1).min().fillna(0).values
    return _ts_min
...
gp_ts_max_5 = make_function(function=_make_ts_max(5), name='ts_max_5', arity=1)
gp_ts_max_20 = make_function(function=_make_ts_max(20), name='ts_max_20', arity=1)
gp_ts_max_40 = make_function(function=_make_ts_max(40), name='ts_max_40', arity=1)

gp_ts_min_5 = make_function(function=_make_ts_min(5), name='ts_min_5', arity=1)
gp_ts_min_20 = make_function(function=_make_ts_min(20), name='ts_min_20', arity=1)
gp_ts_min_40 = make_function(function=_make_ts_min(40), name='ts_min_40', arity=1)

gp_ts_std_5 = make_function(function=_make_ts_std(5), name='ts_std_5', arity=1)
gp_ts_std_20 = make_function(function=_make_ts_std(20), name='ts_std_20', arity=1)
gp_ts_std_40 = make_function(function=_make_ts_std(40), name='ts_std_40', arity=1)
...
_function_map = {'add': add2,
                ...
                'stdd': gp_stdd,
                'rankk': gp_rankk,
                'ts_max_5': gp_ts_max_5,
                'ts_max_20': gp_ts_max_20,
                'ts_max_40': gp_ts_max_40,
                'ts_min_5': gp_ts_min_5,
                'ts_min_20': gp_ts_min_20,
                'ts_min_40': gp_ts_min_40,
                'ts_std_5': gp_ts_std_5,
                'ts_std_20': gp_ts_std_20,
                'ts_std_40': gp_ts_std_40}
